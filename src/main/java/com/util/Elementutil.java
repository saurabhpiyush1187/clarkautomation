...
public class Elementutil implements Baseutil {
	...
	/**
	 * Wait for the element to be clickable in the DOM And returns the first
	...
	/**
	 * Wait for the element to be present in the DOM and displayed And returns the
	...
	/**
	 * This method is used to perform click operation on the element Use it when you
	 * want to click on hidden elements on the page
	 *
	 * @param driver
	 * @param by
	 */

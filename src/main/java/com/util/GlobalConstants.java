...
public class GlobalConstants {
	...
	public static String STAGINGUSERNAME= "clark";
	public static String STAGINGPASSWORD= "We-L0ve-Insurance";
	public static String BASEURL = "staging.clark.de/de/login";
